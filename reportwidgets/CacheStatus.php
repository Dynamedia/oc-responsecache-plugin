<?php namespace Dynamedia\ResponseCache\ReportWidgets;
...
/**
 * Class CacheStatus
 * @package Dynamedia\ResponseCache\ReportWidgets
 */
class CacheStatus extends ReportWidgetBase
{
    ...
    public function onClearAllCache(): array
    {
        ...
        Flash::success(Lang::get('dynamedia.responsecache::lang.reportwidget.cachestatus.flash.all_cleared_success'));
        return $this->renderWidget();
    }
